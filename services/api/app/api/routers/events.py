...
ALLOWED = {
    ...
    "signup",
    "login",
    # acquisition and activation: without these the install-to-first-play funnel cannot be measured at all
    "install",
    "onboarding_start",
    "onboarding_complete",
    "first_play",
    ...
    "referral_share",
    "referral_signup",
    # merchandising: which rail and which position earned the click
    "rail_impression",
    "card_click",
    "shorts_swipe",
    "shorts_watch_depth",
    ...
    "favorite_add",
    "favorite_remove",
    # health: client-side failures are invisible in server logs
    "client_error",
    "offline",
    # QoE
    "play_start",
